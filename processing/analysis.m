...
close all
clc
root = '/Volumes/Research/fieree01lab/labspace/Santiago/Preprocessed_volunteers/Reproducibility_2020_12_01_eve_ricardo';
mkdir(root,'results')
...
for p = 1:numel(params)
    ...
    for sc = 1:numel(scans)
        ...
        wm_mp(:,sc) = parami_mp(wm==20); 
        wm_nomp(:,sc) = parami_nomp(wm==20);
        wm_rmt(:,sc) = parami_rmt(wm==20);
